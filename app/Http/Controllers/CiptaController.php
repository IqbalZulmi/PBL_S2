...
class CiptaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'nik.nullable' => 'nik harus diisi',
            'judul_usulan.nullable' => 'judul usulan harus diisi',
            'file_formulir_permohonan.nullable' => 'file formulir permohonan harus diunggah',
            'file_formulir_permohonan.mimes' => 'file formulir permohonan harus berformat PDF',
            'file_scan_ktp.nullable' => 'file scan KTP harus diunggah',
            'file_scan_ktp.mimes' => 'file scan KTP harus berformat PDF',
            'file_scan_npwp.nullable' => 'file scan NPWP harus diunggah',
            'file_scan_npwp.mimes' => 'file scan NPWP harus berformat PDF',
            'file_contoh_ciptaan.nullable' => 'file contoh ciptaan harus diunggah',
            'file_contoh_ciptaan.mimes' => 'file contoh ciptaan harus berformat PDF',
            'file_surat_pernyataan_hak_cipta.nullable' => 'file surat pernyataan hak cipta harus diunggah',
            'file_surat_pernyataan_hak_cipta.mimes' => 'file surat pernyataan hak cipta harus berformat PDF',
            'file_surat_pengalihan_hak_cipta.nullable' => 'file surat pengalihan hak cipta harus diunggah',
            'file_surat_pengalihan_hak_cipta.mimes' => 'file surat pengalihan hak cipta harus berformat PDF',
            'usulan.nullable' => 'usulan harus diisi',
