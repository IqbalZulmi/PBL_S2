...
<div class="row wht">
    <div class="col-sm-5">
        <div class="mt-2 d-flex justify-content-center">
            <img src="https://learning-if.polibatam.ac.id/theme/image.php/moove/core/1675225508/u/f2" class="rounded-circle w-75 h-100">
        </div>
    </div>
    <div class="col-sm-7">
        ...
        <form action="">
            <div class="mb-3">
                ...
                <input type="text" name="username" class="form-control" id="exampleFormControlInput" disabled readonly required>
            </div>
            <div class="mb-3">
