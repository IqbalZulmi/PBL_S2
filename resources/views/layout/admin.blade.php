                        ...
                        <ul class="dropdown-menu dropdown-menu-end animate slideIn">
                            ...
                            <li class="nav-item">
                                <a class="dropdown-item" href="#">
                                    <i class="fa-regular fa-address-card icon"></i> Profiles
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="dropdown-item" href="#">
                                    <i class="fa-solid fa-key icon"></i> Change Password
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="img-fluid container-fluid text-white">
                <div class="row">
                    <div class="col-md-4 col-lg-3 text-center text-md-start">
                        <a href="dashboard.html" class="h1 text-decoration-none text-white">Sentra HKI</a>
                        ...
                        <div class="offcanvas-body gradient">
                            <ul class="nav-pills navbar-nav">
                                <li class="nav-item me-lg-3 mb-2 mb-sm-0">
                                    <a class="nav-link" href="dashboard.html"><i class="fa-solid fa-house"></i> dashboard</a>
                                </li>
                                <li class="nav-item dropdown me-lg-3 mb-2 mb-sm-0">
                                    ...
                                    <ul class="dropdown-menu animate slideIn">
                                        <li><a class="dropdown-item" href="hak-cipta.html">Hak Cipta</a></li>
                                        <li><a class="dropdown-item" href="hak-paten.html">Hak Paten</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item me-lg-3 mb-2 mb-sm-0">
                                    <a class="nav-link" href="riwayat-pengajuan.html"><i class="fa-solid fa-clock-rotate-left"></i> Riwayat Pengajuan</a>
                                </li>
                            </ul>
                        </div>
                    </div>
