	...
	<div class="limiter">
        <div class="container-login100" style="background-image: url('{{ asset('assets_login/images/bg/poltek1.jpg') }}');">
		  <div class="wrap-login100">
			...
			<form action="/forgot-password" method="POST" class="login100-form validate-form">
			  @csrf
			  ...
			  <div class="wrap-input100 validate-input">
				<input required class="@error('email') is-invalid @enderror input100" type="email" value="{{ old('email') }}" name="email" autocomplete="email" autofocus>
