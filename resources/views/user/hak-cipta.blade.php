    ...
    <div class="col-12 px-4">
        ...
        <form action="/hak-cipta" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-2 row" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="col-9 col-sm-10 col-lg-6">
                    <input type="file" name="file_surat_pengalihan_surat_cipta" id="Pengalihan" onchange="showButton(this)" class="form-control @error('file_surat_pengalihan_surat_cipta') is-invalid @enderror" value="{{ old('file_surat_pengalihan_surat_cipta') }}"required>
                    @error('file_surat_pengalihan_surat_cipta')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <p class="format">*Sudah ditandatangani Direktur,format .pdf</p>
                </div>
            ...
            <div class="mb-2 row" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="col-9 col-sm-10 col-lg-6">
                    <select name="usulan" id="pilih" class="form-select @error('usulan') is-invalid @enderror" required>
            ...
            <div class="mb-2 row" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="col-9 col-sm-10 col-lg-6">
                    <input type="file" name="file_salinan_pks" id="mitra" onchange="showButton(this)" class="form-control @error('file_usulan_pks') is-invalid @enderror" value="{{ old('file_usulan_pks') }}"required/>
                    @error('file_usulan_pks')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <p class="format">*format .pdf</p>
                </div>
